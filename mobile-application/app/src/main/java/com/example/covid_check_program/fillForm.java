...
public class fillForm extends AppCompatActivity {
    ...
    public void goToActiveBluetooth(View view){
        ...
        EditText form_name = (EditText)findViewById(R.id.form_name_editText);
        EditText form_phone = (EditText)findViewById(R.id.form_phone_editText);
        EditText form_email = (EditText)findViewById(R.id.form_email_editText);
